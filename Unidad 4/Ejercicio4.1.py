...
class Alumno:
    #Agregar
    def __init__(self, nombre: str, numero_control: str, carrera=None, promedio: float = 0.0):
        ...
        self.promedio = promedio              # float: Promedio general del alumno.
    ...
    def calcular_promedio(self):
        # Método para calcular el promedio automáticamente basado en las calificaciones
    ...
    def __repr__(self):
        return f'Alumno("{self.nombre}", "{self.numero_control}", promedio={self.promedio})'
...
if __name__ == "__main__":
    ...
    # Calcular promedios
    print(f"\nPromedio de {juan.nombre}: {juan.calcular_promedio()}")
    print(f"Promedio de {luisa.nombre}: {luisa.calcular_promedio()}")
